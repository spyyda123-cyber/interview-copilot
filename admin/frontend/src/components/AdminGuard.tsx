    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-[#f8f9fa] text-slate-800" style={{ fontFamily: "var(--font-dm-sans), sans-serif" }}>
        <div className="flex flex-col items-center gap-4">
          <div className="h-10 w-10 animate-spin rounded-full border-4 border-blue-600/80 border-t-transparent shadow-sm"></div>
          <span className="text-sm font-semibold tracking-wide text-slate-500">Initializing Admin Console...</span>
        </div>
      </div>
    );
  }
