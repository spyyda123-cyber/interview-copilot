      ...
      <div className="w-full max-w-md">
        ...
        <div className="mb-8 text-center">
          <div className="inline-flex h-14 w-14 items-center justify-center rounded-2xl bg-[#222222] mb-4">
            <span className="text-[#d9f36e] text-xl font-black">CA</span>
          </div>
          <h1 className="text-2xl font-bold text-[#222222]">College Admin</h1>
          <p className="mt-1 text-sm text-[#555555]">Manage students, readiness, and token allocations.</p>
        </div>
